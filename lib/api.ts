...
export interface RoomData {
  ...
  sleeps: number;
  size: string;
  rate_3h?: number | string;
  rate_6h?: number | string;
  rate_8h?: number | string;
  rate_daily?: number | string;
  rate_transit_3h?: number | string;
  rate_transit_6h?: number | string;
  rate_transit_8h?: number | string;
  rate_full_day?: number | string;
