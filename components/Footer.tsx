        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 text-xs">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2.5 text-gray-400">
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Pilihan Penginapan</a></li>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2.5 text-gray-400">
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">One Bed Deluxe Room 102 (Lt 10)</a></li>
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Studio Deluxe (Lt 8)</a></li>
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Type 2 Bedroom Luxury (Lt 10)</a></li>
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">One Bed Wood Panel (Lt 6)</a></li>
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">One Bed Skyline (Lt 11)</a></li>
              <li><a href="https://app.freedomroom.id" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">One Bed Luxury (Lt 3)</a></li>
            </ul>
          </div>
